    ...
    <nav className={`top-navbar ${collapsed ? "collapsed" : ""}`}>
      <div className="navbar-content">
        ...
        <div className="navbar-right">
          <div className="icon-item" onClick={handleQRClick} style={{ cursor: "pointer" }}>
      ...
      {/* QR Scanner Modal */}
      <QRScanner isOpen={isQRScannerOpen} onClose={handleCloseQRScanner} onScanSuccess={handleScanSuccess} />
    </nav>
  );
}
