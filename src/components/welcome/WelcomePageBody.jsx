...
import { MdOutlineLocationOn, MdPhoneIphone, MdOutlineMailOutline,MdOutlineContactPage } from "react-icons/md";
            ...
            <div className="welcomePageBody-header">
                <div className='welcomePageBody-cover-background'>
                    ...
                    <div className='welcomePageBody-content'>
                        <div className='welcomePageBody-title-header'>
                            Eco-Z
                        </div>
                    ...
                    <div className='main-content-container'>
                        ...
                        <div className='package-section'>
                            <div className='package-card'>
                                ...
                                <button className='package-btn cursor-target'>Mua ngay</button>
                        ...
                        <div className='bottom-section'>
                            <div className='main-title'>SẠC NHANH - XANH - AN TOÀN CÙNG ECO-Z</div>
                            <button className='register-btn cursor-target'>Đăng ký miễn phí →</button>
                        </div>
                        ...
                        <div className='footer-section'>
                            ...
                            <div className='contact-info'>
                                <div className='contact-title'><MdOutlineLocationOn size={20} /> ĐỊA CHỈ</div>
                            ...
                            <div className='contact-info'>
                                <div className='contact-title'><MdOutlineContactPage size={20} /> LIÊN HỆ</div>
